...
//
// The canonical shared shapes (Technical Build Spec §35). Database rows are
// snake_case; these are camelCase. Conversion happens only in
// packages/api-client/src/case.ts (D-15). Do not hand-roll a case conversion
// anywhere else, and do not rename a field — these names are load-bearing
// across the mobile app, the admin console and the pipeline.
